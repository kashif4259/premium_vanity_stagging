            ...
            <div id="layoutTop" style="position: relative; width: 30rem;">
                <div class="main-layout-card"
                    ...
                    <cart-component-for-update-order
                        ...
                        @editOrderDeliveryChargesFromCart="editOrderDeliveryCharges"
                        @onChangeTaxPercent="onChangeTaxPercent"
                        >
                    </cart-component-for-update-order>
                </div>
            </div>
        ...
        <div class="modal fade modal-hide" id="cart-payment-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered biggest-modal-dialog" role="document">
                <cart-payment-details-for-update-order
                    ...
                    @onChangeDeliveryOrPickup="onChangeDeliveryOrPickup"
                    @deliveryValueChanged="deliveryValueChanged"
