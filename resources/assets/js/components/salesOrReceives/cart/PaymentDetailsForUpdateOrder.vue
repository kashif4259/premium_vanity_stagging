                        ...
                        <div class="text-center header-line-height">
                            ...
                            <span v-if="salesOrReceivingType === 'customer'">
                                <span v-if="finalCart.customer.length === 0">
                                    ...
                                    Customer Name: {{ edit_order_details.order_customer.fullName }}
                                </span>
                            </span>
                                <span v-else>
                            ...
                            <table class="table product-card-font" style="font-weight:500">
                                ...
                                <tr v-for="cartItem in finalCart.cart">
                                    <td class="cart-summary-table text-left">
                                        ...
                                        <br>
                                        <span
                                            v-if="cartItem.productTitle != cartItem.variantTitle && cartItem.variantTitle !== 'default_variant' && cartItem.variantTitle != '' && cartItem.orderType !== 'discount' && cartItem.variantTitle != null ">
                            ...
                            <div v-if="orderType === 'sales'" class="form-group row ml-0">
                                ...
                                <div class="col-4 col-sm-6 col-md-7 col-lg-8 col-xl-8 pl-0">
                                    <select     v-validate="'required'"
                                                ...
                                                @change="onChangeDeliveryOrPickup(deliveryOrPickup)"
                                                >
...
export default {
    ...
    mounted() {
        console.log("paymend details.....");
        console.log("finalCart ==> ",this.finalCart);
        // console.log('paymentListData from payment details for update order vue' + this.paymentListData);
    }
}
</script>