...
export default {
    ...
    created() {
        console.log("edit_order_details =>",this.edit_order_details);
    ...
    watch: {
        ...
        deliveryCharges: function (value) {
            ...
            this.$emit('deliveryValueChanged', value);
    ...
    mounted() {
        ...
        // console.log(instance.finalCart);
        // console.log("====== finalCart =======");
    ...
    methods: {
        ...
        onChangeDeliveryOrPickup(value){
            this.$emit('onChangeDeliveryOrPickup', this.deliveryInfo, value);
        },
