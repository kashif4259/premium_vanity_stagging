...
import {cartItemsToCookie, deleteCartItemsFromCookieOrDB, subTotalAmountForEdit} from "../helper/salesComponentCommonMethod";
...
export default {
    ...
    mounted() {
        ...
        // console.log(
        //  JSON.parse(this.edit_order_details)
        // );
    ...
    methods: {
        ...
        editOrderDeliveryCharges(value, index, unformatted) {
            console.log(" editOrderDeliveryChargesFromCart .... ",value);
            let instance = this;
            console.log(instance);
            this.cart.forEach(function (element) {
                // console.log("element - ",element);
        ...
        setCartItemsToCookieOrDB(flag = 0) {
            ...
            let subTotalAmountMethodData = subTotalAmountForEdit(
        ...
        onChangeDeliveryOrPickup(deliveryInfo, type) {
            console.log("onChangeDeliveryOrPickup.....",deliveryInfo, type);
            let instance = this;
            if(type == "pickup"){
                
                this.cart.forEach(function (element, index, cartItems) {
                    if(element.orderType == "delivery"){
                ...
                this.cart.push(deliveryInfo);
                instance.setCartItemsToCookieOrDB(1);
                this.makeFinalCart('done');
            }
        },
        deliveryValueChanged(value){
            console.log("deliveryValueChanged.....",value); 
            console.log("final Cart from popup =>",this.finalCart)
        ...
        onChangeTaxPercent(value){
            console.log("onChangeTaxPercent.....",value);
            this.taxPercentage = value
            this.updateItemTaxFromTaxPercentage(value);
            // change cartItem.productTaxPercentage
            // instance.setCartItemsToCookieOrDB(1);
            // this.makeFinalCart('done');
            
        },
        updateItemTaxFromTaxPercentage(taxPercentage){
            let instance = this;
            let updatedTax = 0;
            let total = 0;
            this.cart.forEach(function (element) {
                if(element.orderType != "delivery"){
                    ...
                    element.productTaxPercentage = taxPercentage;
                    updatedTax += (element.calculatedPrice * taxPercentage) / 100;
