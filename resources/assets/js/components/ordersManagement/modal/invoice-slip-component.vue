                                            ...
                                            <tbody>
                                                ...
                                                <tr v-for="(item, index) in order.order_items" :key="index" v-if="item.price > 0">
                                                    ...
                                                    <td width="25%" style="padding: 10px;">
                                                        <p>{{ item.title }}</p>
                                                        <ul v-if="item.category_id == 1" style="list-style: none; padding: 0; margin: 0;">
                                                            ...
                                                            <li>
                                                                <table style="width: 100%; border-collapse: collapse; text-align: left;">
                                                                    <thead>
                                                                        <tr>
                                                                            <th style="border: 1px solid #ddd; padding: 8px; text-align: center;">Attribute</th>
                                                            ...
                                                            <!-- Handles Section -->
                                                            <li style="text-align: center; margin-top: 20px; margin-bottom: 10px;">
                                                                <b>Handles</b>
                                                            </li>
                                                            <li>
                                                                <table style="width: 100%; border-collapse: collapse; text-align: left;">
