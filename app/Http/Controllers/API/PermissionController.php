...
class PermissionController extends Controller
{
    ...
    public function ordersManagePermission()
    {
        if($this->permissionCheck()->hasPermission('can_manage_orders') || $this->permissionCheck()->isAdmin())
        {
            return 1;
        }
    ...
    public function todosManagePermission()
    {
        if($this->permissionCheck()->hasPermission('can_manage_todos') || $this->permissionCheck()->isAdmin())
        {
            return 1;
        }
